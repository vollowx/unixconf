...
local components = {
  align        = [[%=]],
  diag         = [[%{%v:lua.require'statusline'.diag()%}]],
  fname        = [[%{%v:lua.require'statusline'.fname()%}]],
  info         = [[%{%v:lua.require'statusline'.info()%}]],
  lsp_progress = [[%{%v:lua.require'statusline'.lsp_progress()%}]],
  mode         = [[%{%v:lua.require'statusline'.mode()%}]],
  padding      = [[ ]],
  pos          = [[%{%&ru?"%l:%c ":""%}]],
  truncate     = [[%<]],
}
